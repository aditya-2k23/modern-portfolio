  ...
  return (
    <DraggableCardContainer className="relative flex min-h-[86vh] md:min-h-[82vh] lg:min-h-[78vh] w-full items-center justify-center overflow-visible py-8 md:py-10 px-4">
      ...
      {skillCategories.map((bucket, idx) => (
        ...
        >
          <div className="relative overflow-hidden rounded-4xl bg-white p-6 shadow-2xl dark:bg-[#0B0F19] border border-neutral-200 dark:border-white/10 w-68 sm:w-72 md:w-76 flex flex-col gap-4 group hover:border-white/20 transition-colors">
